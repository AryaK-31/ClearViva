...
export default function MiniProject() {
    const loadCheckedState = () => {
        const storedState = localStorage.getItem('miniProjectCheckedState');
    ...
    const saveCheckedState = () => {
        localStorage.setItem('miniProjectCheckedState', JSON.stringify(checkedState));
    };
    ...
    return (
        <section id='miniProject' className="text-gray-600 body-font">
            <div className="container px-5 py-24 mx-auto">
                <div className="flex flex-col text-center w-full mb-20">
                    <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-red-600">Mini Project</h1>
                    <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Questions Based on MINI PROJECT</p>
                </div>
